...
interface ButtonProps {
  ...
  variant?: "primary" | "outline" | "error" | "success"; // Button variant
...
const Button: React.FC<ButtonProps> = ({
  ...
  const variantClasses = {
    ...
    success:
      "bg-success-50 text-success-600 border border-success-200 hover:bg-success-100 dark:bg-success-500/15 dark:text-success-500 dark:border-success-800 dark:hover:bg-success-500/25",
  };
